...
ALTV_SERVER_LOG_FOLDER=${ALTV_SERVER_LOG_FOLDER:-""}
...
if [ ! -z "$ALTV_SERVER_LOG_FOLDER" ]; then
    ALTV_SERVER_LOG_FOLDER="--logfolder $ALTV_SERVER_LOG_FOLDER"
fi
...
./altv-server --config=/opt/altv/server.cfg $ALTV_SERVER_LOG_PATH $ALTV_SERVER_LOG_FOLDER $ALTV_SERVER_NO_LOGFILE ${@:1}
